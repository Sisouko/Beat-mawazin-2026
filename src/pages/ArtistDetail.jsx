import { useParams, useNavigate } from 'rect-router-dom'
    ...
    <div className="artist-detail">
     ...
     <div className="artist-details__header">
        <div className="artist-detail__avatar">
            ...
            <span className="artist-detail__genre">{artist.genre}<span/>
        <div/>       
<div className="artist-detail__info">
        <div className="info-item">
          <span className="info-item__icon">📍</span>
          <span className="info-item__value">{artist.stage}</span>
        </div>
        <div className="info-item">
          <span className="info-item__icon">🕐</span>
          <span className="info-item__value">{artist.time}</span>
        </div>
        <div className="info-item">
          <span className="info-item__icon">📅</span>
...
<div className="artist-detail__bio">
        <h2>Biographie</h2>
        <p>{artist.bio}</p>
      </div>
...
}export function default ArtistDetail
